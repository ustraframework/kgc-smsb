<template>
  <v-card>
    <template #text>
      <UMarkdownViewer :content="format1_1" />
      ...
      <UMarkdownViewer :content="format1_2" />
      <UMarkdownViewer :content="format1_3" />
    </template>
  </v-card>
</template>
...
// @ts-ignore
import format1_1 from './md/format1-1.md'

// @ts-ignore
import format1_2 from './md/format1-2.md'

// @ts-ignore
import format1_3 from './md/format1-3.md'
