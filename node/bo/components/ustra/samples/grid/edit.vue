<template>
  <v-card>
    <template #title> 그리드 커스텀 편집</template>
    <template #subtitle> WjFlexGridCellTemplate을 통해 컬럼 편집시 커스터 마이징 적용에 대하여 가이드한다. </template>
    <template #text>
      <div>
      ...
      <!-- <UMarkdownViewer>{{ edit1 }}</UMarkdownViewer> -->
    </template>
  </v-card>
</template>
<script lang="ts" setup>
/**
 * [Demo] 셀 템플릿 개요 : https://demo.grapecity.co.kr/wijmo/learn-wijmo/Grid/CustomCells/CellTemplates/Overview/vue
 * [Demo] 셀 템플릿 일반 : https://demo.grapecity.co.kr/wijmo/learn-wijmo/Grid/CustomCells/CellTemplates/CommonTasks/vue
...
// import edit1 from './md/edit1.md'
import { useWjGridDataMap } from '#ustra/nuxt-wijmo/composables'
 ...
 */
const removeRow = () => {
  grid.value.control.collectionView.remove(grid.value.control.collectionView.currentItem)
}
