    ...
    <UBox class="columns" direction="row">
      <UItem class="card is-sub" ratio="1" >
        ...
        <WjFlexGrid :itemsSource="itemsSourceGrid">
          ...
          <WjFlexGridColumn header="기준1 월 구매적립 건수" binding="col1" width="*" />
          <WjFlexGridColumn header="기준2 단일 영수건 구매금액" binding="col1" width="*" />
          <WjFlexGridColumn header="기준3 월 결제카드 종류" binding="col1" width="*" />
      ...
      <UItem class="card is-sub" ratio="1" >
        ...
        <UFieldSet class="is-large">
          ...
          <UFieldRow :ratio="[1,1,1]">
            <UField required label="월 구매적립 건수">
              <UBox>
                <UTextBox></UTextBox> 
                <span class="desc">건 이상</span>
              </UBox>
            </UField>
            <UField required label="단일 영수건 구매금액">
              <UBox>
                <UTextBox></UTextBox> 
                <span class="desc">원 이상</span>
              </UBox>
            </UField>
            <UField required label="월 결제카드 종류 건수">
              <UBox>
                <UTextBox></UTextBox> 
                <span class="desc">건 이상</span>
              </UBox>
