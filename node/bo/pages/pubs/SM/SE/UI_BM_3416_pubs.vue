      ...
      <UItem class="card is-sub is-search" ratio="1" >
        <UFieldSet class="is-search">
          ...
          <UFieldRow :ratio="[1, 1, 1, '170px']">
            ...
            <UField label="발송ID/제목" ><UTextBox></UTextBox></UField>
            <UField blank>
            </UField>
          </UFieldRow>
        </UFieldSet>
      ...
      <UItem class="card is-sub" ratio="1" >
        <UBox class="table-title-wrap">
          ...
          <UButtonBox class="table-buttons">
            <UButton text="발송 등록" type="is-filled"/>
          </UButtonBox>
        </UBox>
        ...
        <WjFlexGrid :itemsSource="itemsSourceGrid">
          ...
          <WjFlexGridColumn header="발송형태" binding="col1" width="*" align="center"/>
          <WjFlexGridColumn header="발송 ID" binding="col1" width="*" align="center"/>
          <WjFlexGridColumn header="제목" binding="col1" width="*" align="center"/>
          <WjFlexGridColumn header="발송수단" binding="col1" width="*" align="center"/>
          <WjFlexGridColumn header="사용여부" binding="col1" width="*" align="center"/>
          <WjFlexGridColumn header="발송방식" binding="col1" width="*" align="center"/>
