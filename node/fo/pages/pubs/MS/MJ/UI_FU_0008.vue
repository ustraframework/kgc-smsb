    ...
    <div class="w-[550px] mx-auto pt-[80px] pb-[110px]">
      <form action="">
        ...
        <ul class="pt-[20px] mb-[60px]">
          ...
          <li class="flex items-center mb-[24px]">
            <label class="flex-none w-[150px] text-[14px] text-[#222]" for="gender">성별</label>
          ...
          <li class="flex items-start mb-[24px]">
            <label class="flex-none w-[150px] leading-[50px] text-[14px] text-[#222]" for="realBirth">실제 생년월일</label>
            <div class="flex flex-col w-full">
              ...
              <div class="flex items-center pt-[20px]">
                ...
                <p class="text-[13px] text-[#5361E7] ml-[20px]"><span class="font-bold">&middot;</span> 생일정보 입력하시면 혜택을 드립니다</p>
              </div>
            </div>
          </li>
          <li class="flex items-center mb-[24px]">
          ...
          <li class="flex items-start mb-[24px]">
            <label class="flex-none w-[150px] leading-[50px] text-[14px] text-[#222]" for="userId"
              >아이디 <span class="text-[#F46144]">*</span></label
            >
            <div class="flex flex-col w-full">
              <div class="flex gap-2">
          ...
          <li class="flex items-start mb-[24px]">
            <label class="flex-none w-[150px] leading-[50px] text-[14px] text-[#222]" for="userPassword1"
              >비밀번호 <span class="text-[#F46144]">*</span></label
            >
            <div class="flex flex-col w-full">
              <Password
        ...
        <ul class="pt-[20px] mb-[60px]">
          ...
          <li class="flex items-start">
            <label class="flex-none w-[150px] leading-[50px] text-[14px] text-[#222]" for="userAddress">주소</label>
            <div class="flex flex-col w-full">
              <div class="flex gap-2">
        ...
        <ul class="mb-[60px]">
          ...
          <li class="pt-[20px]">
            <div class="flex flex-wrap items-center mb-[22px] gap-6">
              <div class="flex items-center">
