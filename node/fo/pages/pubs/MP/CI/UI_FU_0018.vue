<template>
  <div class="flex flex-col items-center w-[650px]">
    ...
    <div class="w-[650px] bg-[#F4F6FA] p-[16px] rounded-xl text-center">
    ...
    <div class="w-full mt-[40px]">
      <TabView class="default_tab" v-model:activeIndex="activeTab">
        ...
        <!-- 사용가능한 쿠폰 -->
        <TabPanel header="사용가능한 쿠폰">
          <div class="flex justify-between mb-[20px]">
            <span> {{ `총 ${availableList.length}건` }}</span>
        ...
        <TabPanel header="사용완료/기간만료 쿠폰">
          <div class="flex justify-between mb-[20px]">
            <span> {{ `총 ${unavailableList.length}건` }}</span>
            <div class="coupon__search">
              <span
                v-for="(type, i) in selectType"
                :key="i"
