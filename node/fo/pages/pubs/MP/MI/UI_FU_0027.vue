<template>
  ...
  >
    <div class="dialog-content-inner max-h-[456px]">
      <p class="mb-1 text-[16px] text-center text-[#222222]">단골매장을 변경하시려면 휴대폰 인증이 필요합니다.</p>

      <!-- 인증요청 -->
      <div class="w-full flex mt-[24px] gap-[8px]">
        <InputText
          class="flex-1"
          v-model="phoneNumber"
          inputId="integeronly"
      ...
      <!-- 인증번호 입력 -->
      <div class="w-full flex flex-wrap mt-[8px] gap-[8px]" v-if="isShowCert">
