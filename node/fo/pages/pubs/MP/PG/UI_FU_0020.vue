<template>
  <div class="flex flex-col items-center w-[650px]">
    ...
    <div class="flex gap-[8px] w-full mt-[20px]">
      <InputText v-model="name" size="large" placeholder="이름" class="flex-1" />
      <InputText v-model="phoneNumber" size="large" placeholder="휴대폰번호(-없이 입력해주세요)" class="flex-1" />
    ...
    <!-- 유의사항 -->
    <div class="w-full mt-[60px] py-[16px] px-[20px] rounded-[8px] bg-[#F9FAFC]">
